...
public class SchemaCreationFlowLogger
        extends BaseAspect
{
    private static final String FLOW_NAME = "GenericFlow";
    ...
    @Around(
            "execution(* *(..)) && "
                    + "@annotation(io.prestosql.annotations.StartCreateSchemaFlowLoggable)")
    ...
    @Around(
            "execution(* *(..)) &&"
                    + " @annotation(io.prestosql.annotations.CreateSchemaFlowLoggable)")
    ...
    @Around(
            "execution(* *(..)) && "
                    + "@annotation(io.prestosql.annotations.FinishCreateSchemaFlowLoggable)")
