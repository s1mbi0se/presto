...
@Aspect
public class SqlCallFlowLoggingAspect
        extends BaseAspect
{
    private static final String FLOW_NAME = "SqlCallFlow";

    private static final String START_METHOD =
            "execution(* io.prestosql.server.HttpRequestSessionContext"
                    + ".splitHttpHeader(..))";
    ...
    private static final String FINISH_METHOD =
            "execution(* io.prestosql.execution.QueryStateTimer.endQuery())";
    ...
    /**
     * Executed when the Thread starts execution of SQL Call flow.
     *
...
//    @Around(WHITE_AND_BLACK_LIST)
    ...
    /**
     * Executed when the Thread finishes execution of SQL Call flow.
     *
