...
@Aspect
public class SqlShowFlowLoggingAspect
        extends BaseAspect
{
    private static final String FLOW_NAME = "SqlShowFlow";
    ...
    /**
     * This method is executed when the Thread starts execution of SQL SHOW command.
     *
    ...
    /**
     * Executed when the Thread finishes execution of SQL SHOW command .
     *
     ...
     *
     * @param point an object of Aspectj library that represents the method that Presto needs to
     * obtain information inside logs.
     * @return the same object that is returned by the method that is wrapped in this advice
     * @throws Throwable the same exception that is thrown by the method that is wrapped
     */
