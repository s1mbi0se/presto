        ...
        extends BaseAspect
{
    ...
    /**
     * Executed when the Thread starts execution of SQL SELECT command.
     *
     * <p>It is necessary to create the step and debug log id variable for each thread that will
     * execute the flux. So it will delegate processing to {@link
    ...
    /**
     * Executed when the Thread finishes execcution of the SQL SELECT command.
     *
     ...
     * BaseAspect#printDebugLogForMethod(ProceedingJoinPoint, long)} that will be responsible to
     * insert inside the log, information about method executed and it will reset information
